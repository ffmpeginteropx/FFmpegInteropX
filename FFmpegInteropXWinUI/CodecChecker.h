...
namespace winrt::FFmpegInteropXWinUI::implementation
{
    ...
    struct CodecChecker : CodecCheckerT<CodecChecker>
    {
        ...
        static winrt::event_token CodecRequired(winrt::Windows::Foundation::EventHandler<winrt::FFmpegInteropXWinUI::CodecRequiredEventArgs> const& handler);
        ...
        static void RaiseCodecRequired(CodecRequiredReason reason, hstring const& codecName, hstring const& storeEntryName, hstring const& uri)
        {
            ...
            auto args = winrt::make_self<winrt::FFmpegInteropXWinUI::implementation::CodecRequiredEventArgs>(reason, codecName, storeEntryName, uri);
    ...
    private:
        static winrt::event<Windows::Foundation::EventHandler<winrt::FFmpegInteropXWinUI::CodecRequiredEventArgs>> m_codecRequiredEvent;
