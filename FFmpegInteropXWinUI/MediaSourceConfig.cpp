...
namespace winrt::FFmpegInteropXWinUI::implementation
{
    ...
    FFmpegInteropXWinUI::VideoDecoderMode MediaSourceConfig::VideoDecoderMode()
    {
        return m_VideoDecoderMode;
    }

    void MediaSourceConfig::VideoDecoderMode(FFmpegInteropXWinUI::VideoDecoderMode const& value)
    {
    ...
    FFmpegInteropXWinUI::CharacterEncoding MediaSourceConfig::AnsiSubtitleEncoding()
    {
        return m_CharacterEncoding;
    }

    void MediaSourceConfig::AnsiSubtitleEncoding(FFmpegInteropXWinUI::CharacterEncoding const& value)
    {
        if (value == nullptr)
