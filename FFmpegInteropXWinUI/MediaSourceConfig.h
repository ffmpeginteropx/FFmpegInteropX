...
namespace winrt::FFmpegInteropXWinUI::implementation
{
	...
	private:
		...
		int m_SystemDecoderH264MaxProfile;
		...
		bool m_AutoCorrectAnsiSubtitles;
		...
		bool m_UseEmbeddedSubtitleFonts;
		...
		bool m_PreventModifiedSubtitleDurationOverlap;
		...
		bool m_DownmixAudioStreamsToStereo;
