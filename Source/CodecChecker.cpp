...
{
    winrt::event_token CodecChecker::CodecRequired(winrt::Windows::Foundation::EventHandler<winrt::FFmpegInteropX::CodecRequiredEventArgs> const& handler)
    {
    ...
    winrt::event<Windows::Foundation::EventHandler<winrt::FFmpegInteropX::CodecRequiredEventArgs>> CodecChecker::m_codecRequiredEvent {};
