...
namespace winrt::FFmpegInteropX::implementation
{
        ...
        winrt::Windows::Media::Core::VideoStreamDescriptor videoDescriptor)
    {
        ...
        auto parser = co_await winrt::FFmpegInteropX::implementation::FFmpegMediaSource::ReadExternalSubtitleStreamAsync(stream, streamName, config, videoDescriptor, 0, false);
