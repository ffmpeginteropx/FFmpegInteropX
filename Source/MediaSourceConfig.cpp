...
namespace winrt::FFmpegInteropX::implementation
{
    ...
    {
        m_ReadAheadBufferSize = value;
    }

    long long MediaSourceConfig::ReadAheadBufferSize()
    {
        return m_ReadAheadBufferSize;
    }

    void MediaSourceConfig::ReadAheadBufferDuration(Windows::Foundation::TimeSpan const& value)
    {
        m_ReadAheadBufferDuration = value;
    }

    Windows::Foundation::TimeSpan MediaSourceConfig::ReadAheadBufferDuration()
    {
        return m_ReadAheadBufferDuration;
    }
