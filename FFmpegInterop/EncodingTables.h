...
namespace FFmpegInterop {
	...
	internal:
		EncodingTable(int p_windowsTable, String^ p_name, String^ p_description)
		{
	...
	public:
		static IVectorView<EncodingTable^>^ GetTables()
		{
			if (internalMap == nullptr) {
				...
				internalMap->Append(ref new EncodingTable(0, "", "System locale"));
				internalMap->Append(ref new EncodingTable(65001, "CP65001", "Unicode (UTF-8)"));
				internalMap->Append(ref new EncodingTable(1200, "CP1200", "Unicode UTF-16, little endian byte order (BMP of ISO 10646)"));
				internalMap->Append(ref new EncodingTable(1201, "CP1201", "Unicode UTF-16, big endian byte order"));
				internalMap->Append(ref new EncodingTable(12000, "CP12000", "Unicode UTF-32, little endian byte order"));
				internalMap->Append(ref new EncodingTable(12001, "CP12001", "Unicode UTF-32, big endian byte order"));

				internalMap->Append(ref new EncodingTable(154, "CP154", "Cyrillic-asian"));
				internalMap->Append(ref new EncodingTable(1133, "CP1133", "IBM Lao Script"));
				internalMap->Append(ref new EncodingTable(853, "CP853", " DOS for Turkish, Maltese, and Esperanto."));
				internalMap->Append(ref new EncodingTable(1125, "CP1125", "Legacy Latin"));
