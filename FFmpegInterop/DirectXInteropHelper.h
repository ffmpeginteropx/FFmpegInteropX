...
internal:
	...
	static HRESULT GetDeviceFromStreamSource(MediaStreamSource^ source, ID3D11Device** outDevice, ID3D11DeviceContext** outDeviceContext, ID3D11VideoDevice** outVideoDevice);
